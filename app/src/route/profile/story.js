...
* @Last Modified time: 2018-03-04 14:09:00
*/
...
import BoxCard from './../../component/boxcard/boxcard'
					...
					<article>
						...
						<div className="pure-menu pure-menu-horizontal center">
						    <ul className="pure-menu-list">
						        ...
						        <li className="pure-menu-item"><Link to="stories" className="pure-menu-link nav-active">Stories</Link></li>
